...
T = TypeVar("T", bound="UpdateEmailMessageRequestContactPropertiesFallbacks")
...
class UpdateEmailMessageRequestContactPropertiesFallbacks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        update_email_message_request_contact_properties_fallbacks = cls()
        ...
        update_email_message_request_contact_properties_fallbacks.additional_properties = additional_properties
        return update_email_message_request_contact_properties_fallbacks
