...
T = TypeVar("T", bound="AudienceFilterWorkflowMutationNode")


@_attrs_define
class AudienceFilterWorkflowMutationNode:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        audience_filter_workflow_mutation_node = cls(
            id=id,
            type_name=type_name,
        ...
        audience_filter_workflow_mutation_node.additional_properties = d
        return audience_filter_workflow_mutation_node
