...
T = TypeVar("T", bound="ListComponentsResponsePagination")


@_attrs_define
class ListComponentsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_components_response_pagination = cls(
        ...
        list_components_response_pagination.additional_properties = d
        return list_components_response_pagination
