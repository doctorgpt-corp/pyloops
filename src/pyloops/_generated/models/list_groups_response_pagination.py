...
T = TypeVar("T", bound="ListGroupsResponsePagination")


@_attrs_define
class ListGroupsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_response_pagination = cls(
        ...
        list_groups_response_pagination.additional_properties = d
        return list_groups_response_pagination
