...
T = TypeVar("T", bound="ListEventPatternsResponsePagination")


@_attrs_define
class ListEventPatternsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_event_patterns_response_pagination = cls(
        ...
        list_event_patterns_response_pagination.additional_properties = d
        return list_event_patterns_response_pagination
