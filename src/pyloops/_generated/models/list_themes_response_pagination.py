...
T = TypeVar("T", bound="ListThemesResponsePagination")


@_attrs_define
class ListThemesResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_themes_response_pagination = cls(
        ...
        list_themes_response_pagination.additional_properties = d
        return list_themes_response_pagination
