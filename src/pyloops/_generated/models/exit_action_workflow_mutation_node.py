...
T = TypeVar("T", bound="ExitActionWorkflowMutationNode")


@_attrs_define
class ExitActionWorkflowMutationNode:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        exit_action_workflow_mutation_node = cls(
            id=id,
            type_name=type_name,
            next_node_ids=next_node_ids,
        )

        exit_action_workflow_mutation_node.additional_properties = d
        return exit_action_workflow_mutation_node
