...
from ..models.audience_filter_in_request_type_0_match import AudienceFilterInRequestType0Match
...
T = TypeVar("T", bound="AudienceFilterInRequestType0")


@_attrs_define
class AudienceFilterInRequestType0:
    """A tree of audience conditions combined with `match`. Setting this without also providing `audienceSegmentId` clears
    any existing `audienceSegmentId`. When both are provided, this filter is applied on top of the segment's filter.

        Attributes:
            match (AudienceFilterInRequestType0Match):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        audience_filter_in_request_type_0 = cls(
            match=match,
            conditions=conditions,
        )

        return audience_filter_in_request_type_0
