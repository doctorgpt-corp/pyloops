...
T = TypeVar("T", bound="ContactPropertyTriggerWorkflowMutationNode")


@_attrs_define
class ContactPropertyTriggerWorkflowMutationNode:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_property_trigger_workflow_mutation_node = cls(
            id=id,
            type_name=type_name,
        ...
        contact_property_trigger_workflow_mutation_node.additional_properties = d
        return contact_property_trigger_workflow_mutation_node
