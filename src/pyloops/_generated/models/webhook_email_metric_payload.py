...
from ..models.webhook_email_metric_payload_source_type import WebhookEmailMetricPayloadSourceType
...
T = TypeVar("T", bound="WebhookEmailMetricPayload")


@_attrs_define
class WebhookEmailMetricPayload:
    """
    Attributes:
        event_name (str):
        ...
        email (WebhookEmail):
        source_type (WebhookEmailMetricPayloadSourceType): The type of email this event relates to. Workflow emails use
            `loop`.
        ...
        transactional_id (str | Unset): The ID of the transactional email if `sourceType` is `transactional`.
    """
    ...
    contact_identity: WebhookContactIdentity
    email: WebhookEmail
    source_type: WebhookEmailMetricPayloadSourceType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_email import WebhookEmail  # noqa: PLC0415
        ...
        source_type = WebhookEmailMetricPayloadSourceType(d.pop("sourceType"))
        ...
        webhook_email_metric_payload = cls(
        ...
        webhook_email_metric_payload.additional_properties = d
        return webhook_email_metric_payload
