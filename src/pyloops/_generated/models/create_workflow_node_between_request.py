...
from ..models.create_workflow_node_between_request_insert_mode import CreateWorkflowNodeBetweenRequestInsertMode
from ..models.create_workflow_node_type_name import CreateWorkflowNodeTypeName

T = TypeVar("T", bound="CreateWorkflowNodeBetweenRequest")
...
class CreateWorkflowNodeBetweenRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        insert_mode = CreateWorkflowNodeBetweenRequestInsertMode(d.pop("insertMode"))
        ...
        create_workflow_node_between_request = cls(
        ...
        return create_workflow_node_between_request
