...
T = TypeVar("T", bound="ListTransactionalsResourceResponsePagination")


@_attrs_define
class ListTransactionalsResourceResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_transactionals_resource_response_pagination = cls(
        ...
        list_transactionals_resource_response_pagination.additional_properties = d
        return list_transactionals_resource_response_pagination
