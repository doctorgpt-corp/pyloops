...
T = TypeVar("T", bound="VariantWorkflowMutationNodeWithRevision")


@_attrs_define
class VariantWorkflowMutationNodeWithRevision:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variant_workflow_mutation_node_with_revision = cls(
            id=id,
            type_name=type_name,
        ...
        variant_workflow_mutation_node_with_revision.additional_properties = d
        return variant_workflow_mutation_node_with_revision
