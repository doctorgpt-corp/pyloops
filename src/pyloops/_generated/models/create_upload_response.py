...
T = TypeVar("T", bound="CreateUploadResponse")
...
class CreateUploadResponse:
    """
    Attributes:
        email_asset_id (str): The ID of the created asset. Pass this as `emailAssetId` to `POST
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        presigned_url = d.pop("presignedUrl")

        create_upload_response = cls(
            email_asset_id=email_asset_id,
            presigned_url=presigned_url,
        )

        create_upload_response.additional_properties = d
