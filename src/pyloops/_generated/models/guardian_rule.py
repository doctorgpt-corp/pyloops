...
class GuardianRule:
    ...
    Attributes:
        ...
        title (str): A human-readable title for the rule.
        description (str): A human-readable explanation of the rule.
        items (list[GuardianRuleItemsItem]): The individual items that triggered the rule.
    """
