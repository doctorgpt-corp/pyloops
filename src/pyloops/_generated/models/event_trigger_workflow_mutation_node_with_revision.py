...
T = TypeVar("T", bound="EventTriggerWorkflowMutationNodeWithRevision")


@_attrs_define
class EventTriggerWorkflowMutationNodeWithRevision:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_trigger_workflow_mutation_node_with_revision = cls(
            id=id,
            type_name=type_name,
        ...
        event_trigger_workflow_mutation_node_with_revision.additional_properties = d
        return event_trigger_workflow_mutation_node_with_revision
