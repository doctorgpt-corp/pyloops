...
T = TypeVar("T", bound="SendEmailActionWorkflowMutationNodeWithRevision")


@_attrs_define
class SendEmailActionWorkflowMutationNodeWithRevision:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        send_email_action_workflow_mutation_node_with_revision = cls(
            id=id,
            type_name=type_name,
        ...
        send_email_action_workflow_mutation_node_with_revision.additional_properties = d
        return send_email_action_workflow_mutation_node_with_revision
