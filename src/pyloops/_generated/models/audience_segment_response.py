...
T = TypeVar("T", bound="AudienceSegmentResponse")
...
class AudienceSegmentResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        audience_segment_response.additional_properties = d
        return audience_segment_response
