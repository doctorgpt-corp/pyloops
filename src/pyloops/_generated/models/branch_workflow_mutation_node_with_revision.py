...
T = TypeVar("T", bound="BranchWorkflowMutationNodeWithRevision")


@_attrs_define
class BranchWorkflowMutationNodeWithRevision:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        branch_workflow_mutation_node_with_revision = cls(
            id=id,
            type_name=type_name,
        ...
        branch_workflow_mutation_node_with_revision.additional_properties = d
        return branch_workflow_mutation_node_with_revision
