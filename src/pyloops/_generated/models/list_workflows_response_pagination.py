...
T = TypeVar("T", bound="ListWorkflowsResponsePagination")


@_attrs_define
class ListWorkflowsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_workflows_response_pagination = cls(
        ...
        list_workflows_response_pagination.additional_properties = d
        return list_workflows_response_pagination
