...
T = TypeVar("T", bound="ListAudienceSegmentsResponsePagination")


@_attrs_define
class ListAudienceSegmentsResponsePagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_audience_segments_response_pagination = cls(
        ...
        list_audience_segments_response_pagination.additional_properties = d
        return list_audience_segments_response_pagination
