...
) -> Any | ListWorkflowsResponse | WorkflowFailureResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ListWorkflowsResponse | WorkflowFailureResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | ListWorkflowsResponse | WorkflowFailureResponse
    """
