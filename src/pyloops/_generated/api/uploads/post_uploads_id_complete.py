...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/uploads/{id}/complete".format(
...
) -> Any | CompleteUploadResponse | UploadFailureResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CompleteUploadResponse | UploadFailureResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | CompleteUploadResponse | UploadFailureResponse
    """
