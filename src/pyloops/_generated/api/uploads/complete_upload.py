...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/uploads/{email_asset_id}/complete".format(
            email_asset_id=quote(str(email_asset_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Complete an upload
     ...
     Finalize an image upload after the file has been uploaded to the pre-signed URL. Returns the public
    URL of the uploaded image asset.
