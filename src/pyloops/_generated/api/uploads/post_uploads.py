...
) -> Any | CreateUploadResponse | UploadFailureResponse | UploadLimitExceededFailureResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | CreateUploadResponse | UploadFailureResponse | UploadLimitExceededFailureResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | CreateUploadResponse | UploadFailureResponse | UploadLimitExceededFailureResponse
    """
