...
) -> Any | ComponentFailureResponse | ListComponentsResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ComponentFailureResponse | ListComponentsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | ComponentFailureResponse | ListComponentsResponse
    """
