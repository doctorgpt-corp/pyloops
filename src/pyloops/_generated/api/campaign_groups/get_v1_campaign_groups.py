...
) -> Any | GroupFailureResponse | ListGroupsResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GroupFailureResponse | ListGroupsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | GroupFailureResponse | ListGroupsResponse
    """
